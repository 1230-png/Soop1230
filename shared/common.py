"""Shared helpers for ASMR-based food shorts: font lookup, background
palettes, text rendering, and ffmpeg muxing/concatenation.

No TTS (Text-to-Speech) — this version uses ASMR cooking sound effects
