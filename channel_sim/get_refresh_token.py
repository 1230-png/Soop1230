"""「돌려 보는 알고리즘」 refresh token 발급 — **본인 컴퓨터에서** 한 번만 돌린다.
...
def main():
    ...
    print("브라우저가 열립니다. **「돌려 보는 알고리즘」를 관리하는 계정**으로 "
          "로그인하세요.\n"
    ...
    print("바꾼 뒤 워크플로를 workflow_dispatch 로 한 번 돌려 보세요. "
          "토큰이 멀쩡한지 영상 한 편 안 만들고 확인됩니다.")
